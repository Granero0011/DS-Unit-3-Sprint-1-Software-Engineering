...
An important part of code review in my opinion is indentation. I have a tendency to make
indentation mistakes on my own code, it sometimes generate random mistakes that might become
difficult to catch in a long piece of code.

- We have an awful lot of computers here, and it gets pretty confusing with
  slightly different things running on all of them. How could containers help us
  improve this situation?
Containers could help us organize  the process in a way that we get a better understanding
of what goes in as inputs in each computer. Knowing and organizing your containers allow you to differentiate the data processing techniques running on all different computers.
